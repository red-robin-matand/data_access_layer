...
from data_access_layer.connections import CloudWatchLogsConnection
from data_access_layer.datasources.exceptions import CloudWatchDatasourceError

import pandas as pd


class CloudWatchLogsDataSource(DataSource):

    def __init__(self, connection: CloudWatchLogsConnection):
